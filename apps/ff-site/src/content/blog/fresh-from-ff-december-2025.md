---
title: "Fresh From FF: December, 2025"
created-on: 2025-12-09T14:00:00.000Z
updated-on: 2025-12-09T14:00:00.000Z
published-on: 2025-12-09T14:00:00.000Z
category: reports
description: "Check out the latest updates about what Filecoin Foundation has been up to. "
image:
  src: /assets/images/0215-ff-28-.webp
seo:
  description: "Check out the latest updates about what Filecoin Foundation has
    been up to in December, 2025. "
---
**On November 18, 2025, the Filecoin ecosystem introduced Filecoin Onchain Cloud at DePIN Day Buenos Aires.** Filecoin Onchain Cloud is a decentralized, onchain layer that provides verifiable storage, retrieval, and payments. Built on the world’s largest decentralized storage network, Filecoin Onchain Cloud exposes core cloud functions into programmable, verifiable services that allows developers to build directly on infrastructure that proves where data lives, how it’s accessed, and when it’s paid for.**[ Read more](https://filecoin.io/blog/posts/filecoin-onchain-cloud-launch-roundup/).**
...
* [Introducing Synapse SDK](https://docs.filecoin.cloud/getting-started/?utm_campaign=filecoin-news-119&utm_medium=referral&utm_source=filecoin-news.beehiiv.com). Filecoin Synapse SDKis a simple, easy-to-use Javascript SDK for builders to access Filecoin Onchain Cloud flagship services to power new dApps and smart contracts.It lets developers upload, retrieve, and pay for storage using simple, high-level APIs. 
...
* **[Monad’s Vision for Decentralized AI](https://youtu.be/7WXk2SKYauk?si=2luCNSUzU4D7k7hp).** Hear from Eunice Giarta, Co-Founder/GM at Monad Foundation, live from DePIN Day, about the importance of decentralized infrastructure, building resilient systems for AI, and how Monad is helping startups connect to Filecoin services.
* **[How DIMO Is Powering the Future of Vehicle AI.](https://youtu.be/YO9nizqHmgY?si=fBLMzdGmNO8JLd2X)** DIMO co-founder Alex Rawitz joins DWeb Decoded to break down how vehicle data is underutilized and how DIMO’s decentralized infrastructure is unlocking it.
* **[How Lighthouse Is Powering Permanent Storage and Tokenized Data Economies on Filecoin](https://youtu.be/8XYGrLRe7kA?si=-gHFOOM7Tf_kU4ZO)**. Lighthouse CEO Nandit Mehra joins DWeb Decoded to discuss how the platform has evolved over the past year — from programmable storage to encrypted, retrievable, tokenized data. Learn how Lighthouse is enabling permanent storage on Filecoin, the rise of AI agents with Eternal AI, and the launch of the new platform for monetizing data.

...
[[Ungate](/ecosystem-explorer/ungate) integrates Filecoin to enhance security, scalability, and reliability](https://x.com/UngateAI/status/1899802770821226549). [Ungate](/ecosystem-explorer/ungate) Wukong – the Autonomous Verification Stack (AVS) for AI agents – is changing how autonomous agents operate through cryptographically verifiable and transparent actions. [Ungate](/ecosystem-explorer/ungate) has integrated Filecoin via [[Lighthouse](/ecosystem-explorer/lighthouse)](https://www.lighthouse.storage/), a platform built with Filecoin offering perpetual storage, to archive AI-generated proofs on decentralized storage. 

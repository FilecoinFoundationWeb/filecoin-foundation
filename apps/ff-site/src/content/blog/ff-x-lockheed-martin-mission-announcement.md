...
Previously, in May 2022 in Davos, FF [announced an initial effort](/blog/filecoin-foundation-and-lockheed-martin-bring-decentralized-storage-to-space) with Lockheed Martin to deploy IPFS in space to improve the speed of data transfer across long distances. This mission is the next step in that project, bringing the benefits of decentralized storage to space and exploring use cases for how IPFS can enable better interplanetary communication and data transfer.

...
- [Get an inside look at a Filecoin data center](https://youtu.be/ZTWiicsYVOY?feature=shared)! Take a tour of [DCENT](/ecosystem-explorer/dcent), Europe’s largest Filecoin storage provider in the first-ever DWeb Decoded Special Report. Co-founder Hidde Hoogland showcases how [DCENT](/ecosystem-explorer/dcent) blends high-performance infrastructure with sustainable energy solutions to power the future of Web3.

...
[Ghostdrive](/ecosystem-explorer/ghostdrive): Ghostdrive leverages the benefits of file encryption, decentralized storage, and asset tokenization using a multi-platform application. With IPFS and Filecoin, it provides an innovative and secure way to store, share, and enable data exchange markets. 
...
[Lighthouse](/ecosystem-explorer/lighthouse) [FVM Tooling](https://github.com/filecoin-project/devgrants/issues/1624): This project aims to make tools for developers to use FVM easily and build on Filecoin with the best developer experience. 
...
**Victor Chang Cardiac Research Institute:** Working with [DeStor](/ecosystem-explorer/destor), the Victor Chang Institute has uploaded 125+ TiB of [cardiac research data](https://x.com/FilFoundation/status/1839371321777520919) to Filecoin, including cell images and encrypted machine backups.

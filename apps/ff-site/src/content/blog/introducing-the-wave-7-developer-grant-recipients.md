...
[[Lighthouse](/ecosystem-explorer/lighthouse) Filecoin-Ethereum Infra](https://github.com/nandit123/devgrants/blob/master/open-grant-proposals/lighthouse.md)

[Lighthouse](/ecosystem-explorer/lighthouse) provides a way for Ethereum smart contracts to request Filecoin storage of content identifiers (CIDs) in IPFS via Textile’s Powergate. With this cross-chain infrastructure, DeFi and NFT-related projects building on the Ethereum blockchain will be able to employ [Lighthouse](/ecosystem-explorer/lighthouse) for verifiable storage on the Filecoin Network.

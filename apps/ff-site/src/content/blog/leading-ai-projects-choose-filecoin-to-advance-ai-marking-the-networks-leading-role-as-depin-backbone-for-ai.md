...
description: "Network announcements include collaborations with SingularityNET,
  Theoriq, [Bagel](/ecosystem-explorer/bagel), and [Nuklai](/ecosystem-explorer/nuklai)."
image:
  src: /assets/images/120624-brussels.jpg
seo:
  description: Filecoin Foundation collaborates with SingularityNET, Theoriq,
    [Bagel](/ecosystem-explorer/bagel), [Nuklai](/ecosystem-explorer/nuklai), and more to enhance AI with decentralized storage and secure
    data solutions.
---
...
[[Bagel](/ecosystem-explorer/bagel)](https://www.bagel.net/), an AI and cryptography research lab, and Filecoin Foundation are collaborating to enable AI developers to train and store their models using the compute and storage power of the Filecoin network. With [Bagel](/ecosystem-explorer/bagel)’s decentralized compute network aggregator, Filecoin storage providers will be able to utilize both storage and computational resources, increasing revenue, optimizing compute resource utilization, and accelerating adoption by offering a comprehensive solution for ML workloads.

## Accelerating and Securing Access to AI Data

[[Nuklai](/ecosystem-explorer/nuklai)](https://www.nukl.ai/), a collaborative data marketplace and infrastructure provider for data ecosystems, has integrated Filecoin through [Lighthouse](/ecosystem-explorer/lighthouse) to make [Nuklai](/ecosystem-explorer/nuklai)’s metadata publicly accessible. [Nuklai](/ecosystem-explorer/nuklai) plans to support secure data uploads to the InterPlanetary File System (IPFS) in the future and is exploring integrating Filecoin as a data storage cluster within its Layer 1 network for enterprise and other use cases, providing a perpetual and decentralized data storage model. Read the [[Nuklai](/ecosystem-explorer/nuklai) announcement](https://www.nukl.ai/blog/nuklai-and-filecoin-foundation-collaborate-to-archive-the-worlds-data).
...
## Qamcom DDS and [DeStor](/ecosystem-explorer/destor) Partner to Enhance Data Privacy and Security

[Qamcom](https://www.qamcom.com/) DDS and [[DeStor](/ecosystem-explorer/destor)](https://destor.com/) announced a partnership to provide enhanced security, robustness, and petabyte-scale storage services on the Filecoin network. The partnership has secured two clients, including Swedish startups [YayPal](https://www.yaypal.io/), a Web3 gaming studio with over 500,000 users for its flagship game Yay Ride, and [Fieldstream](https://www.fieldstream.ai/), an AI marketing analytics platform. [DeStor](/ecosystem-explorer/destor)'s platform offers verifiable storage solutions that ensure data integrity and availability through daily data verification. And the partnership with Qamcom DDS allows clients to store extensive data securely and efficiently, ensuring confidentiality and protection. Read [[DeStor](/ecosystem-explorer/destor)’s announcement](https://destor.com/resources/news/qamcom-dds-destor-partnership).

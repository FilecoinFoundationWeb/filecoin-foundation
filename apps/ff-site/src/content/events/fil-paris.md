...
program:
  events:
    ...
    - title: Funding the Commons
      ...
      location: Sorbonne University 15-21 Rue de I-Ecole de medecine
      description:
    ...
    - title: Storage Providers Workshops
      ...
      description:
        Join our workshops around what its like to be a storage provider in
    ...
    - title: Proof of Space days
      ...
      description: Protocol Labs' Cryptonet is hosting Proof of Space days, a
        ...
        knowledge on Proof of Space. We'll have talks and workshops to
    ...
    - title: Filecoin Builders Day
      ...
      description:
        ...
        Filecoin Virtual Machine, developers and more will be on site to share
    ...
    - title: Filecoin Orbit and Friends Happy Hour
      ...
      description: After all the great sessions, stick around to say that you've
        partied on the Siene. Filecoin Orbit along with Kryptosphere present our

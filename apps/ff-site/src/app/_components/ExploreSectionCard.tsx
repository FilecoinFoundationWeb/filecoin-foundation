...
export function ExploreSectionCard({
  ...
  return (
    <li className="relative flex flex-col justify-between gap-3 rounded-lg border border-brand-500 bg-brand-700/10 p-4 backdrop-blur-md hover:bg-brand-overlay/20">

  ...
  return (
    <>
      ...
      <PageSection backgroundVariant="light">
        <SectionContent title="Light Buttons">
          ...
          <div className="flex gap-4">
            ...
            <Button href="https://docs.filecoin.io/" variant="ghost">
              Explore documentation
            </Button>
            <Button href="#" variant="ghost" icon={GithubLogoIcon}>
              GitHub
            </Button>
          </div>
        </SectionContent>
      ...
      <PageSection backgroundVariant="dark">
        <SectionContent title="Dark Buttons">
          <div className="flex gap-4">
            <Button href={PATHS.BUILD_ON_FILECOIN.path} variant="primary">
              Explore builder's hub
            </Button>
      ...
      <PageSection backgroundVariant="gray">
        <SectionContent title="Gray Buttons">
          <div className="flex gap-4">
            <Button href={PATHS.BUILD_ON_FILECOIN.path} variant="primary">
              Explore builder's hub
            </Button>

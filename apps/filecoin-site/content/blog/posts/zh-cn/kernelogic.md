...
得益于由存储提供者、开发者和生态合作伙伴组成的强大社区，Filecoin目前提供了超过18 EiB的分布式存储。这种[岛屿经济](/blog/filecoin-s-island-economy/)正被像Kernelogic这样对保存有益信息的大型数据集感兴趣的客户所利用。

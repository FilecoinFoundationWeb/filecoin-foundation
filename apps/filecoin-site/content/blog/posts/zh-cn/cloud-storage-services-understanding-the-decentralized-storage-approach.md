...
简而言之，Filecoin通过引入区块链网络和激励机制，奖励独立存储提供者为网络提供[存储功率](/blog/a-guide-to-filecoin-storage-mining/)、存储容量以及检索文件，进一步推动了IPFS的创新。这些分别被称为网络的存储市场和检索市场。
...
总的说来，这意味着Filecoin能够提供\[数据持久性\] (/blog/ipfs-filecoin-and-content-persistence/)。

_(通过这些资源，可深入了解_[_Filecoin_](/blog/filecoin-network-economics/)_和_[_存储提供者_](/blog/the-economics-of-storage-providers/)_的经济学知识。)_

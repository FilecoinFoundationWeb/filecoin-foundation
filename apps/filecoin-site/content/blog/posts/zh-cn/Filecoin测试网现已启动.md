...
今天是Filecoin具有里程碑意义的一天，我们的Filecoin测试网([准时](/blog/filecoin-2019-q2-q3-update/#1-launches-testnet-on-dec-11-mainnet-in-2020-q1))上线了！经过了大量的研究，设计和开发，Filecoin协议已经为网络测试做好准备。我们非常激动地和大家分享这个消息！
...
1. [加入测试网](/blog/filecoin-testnet-is-live/#join-the-testnet) 2. [加入Filecoin社区](/blog/filecoin-testnet-is-live/#join-the-filecoin-community) 3. [参加线上答疑](/blog/filecoin-testnet-is-live/#participate-in-our-testnet-ama) 3. [攻下测试网](/blog/filecoin-testnet-is-live/#break-the-testnet-report-issues) 4. [发给我们产品反馈](/blog/filecoin-testnet-is-live/#send-us-product-feedback) 5. [矿工测试](/blog/filecoin-testnet-is-live/#participate-in-miner-testing) 6. [构建Filecoin生态](/blog/filecoin-testnet-is-live/#build-the-filecoin-ecosystem)
...
我们在2019年取得了长足的进步，今年1月，我们从一个核心团队、一个闭源代码库和一个充满好奇的社区开始，到2月我们进入Filecoin以开放、深入地研究、协议设计和快速研发为标志的新阶段。Filecoin项目和社区从那之后成长迅速。我们有几百个社区大使组办的线下见面，几十个和大学还有生态伙伴的合作，在[第一期Filecoin开发津贴项目](/blog/filecoin-dev-grants-wave-1-recipients-wave-2-now-open/)中为六个项目提供了开发补助, 发布了五个[go-filecoin版本](https://github.com/filecoin-project/go-filecoin/blob/master/CHANGELOG.md)，上线了[lotus](/blog/announcing-lotus-our-first-alternate-filecoin-implementation/)和[go-filecoin alphanet](/blog/announcing-the-go-filecoin-alphanet/)，发布了新的网络可视化工具 得到几百个来自社区的技术贡献等等。

...
**网络**。如果您使用分布式Lotus封装（请参考下文的[高级挖矿配置](/blog/a-guide-to-filecoin-storage-mining/#advanced-mining-considerations)），则建议使用高性能网络（建议使用10GbE+网卡和交换机）。使用网络附加存储时也建议使用高性能网络。

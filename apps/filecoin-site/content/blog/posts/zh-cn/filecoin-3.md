...
![Filecoin Spec Header](/blog/fil-spec-header.png)
...
![Filecoin Spec Facelift](/blog/fil-spec-facelift.png)
...
![Filecoin Spec Stats](/blog/fil-spec-stats.png)
...
![Filecoin Spec Legend](/blog/fil-spec-legend.png)

**2. “审计完成度” 指标**作为仪表板的单独一栏，显示协议的具体组成部分是否已被审计。在有审计报告的情况下，将标明报告(或以前报告的清单)的链接及审计的日期。

![Filecoin Spec Dashboard](/blog/fil-spec-dashboard2.png)

**3. 稳定的进度条显示** ，用来总结整个规范的状态。

![Filecoin Spec Progressbar](/blog/fil-spec-progressbar-85.png)
...
![Filecoin Spec Implementations](/blog/fil-spec-implementations.png)

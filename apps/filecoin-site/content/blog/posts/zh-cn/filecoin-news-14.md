...
请看[**这篇博文**](/blog/how-storage-and-retrieval-deals-work-on-filecoin/)，它涵盖了Filecoin中两类交易的基本阶段--存储交易和检索交易，并详细介绍了它们的生命周期。
...
如果您刚刚开始了解我们，[**Filecoin博客**](/blog)和我们的[**YouTube频道**](https://www.youtube.com/channel/UCPyYmtJYQwxM-EUyRUTp5DA)也是很好的信息来源。如果所有其他方法都失败了，请发送回复到这封邮件，我们将帮助你找到答案。

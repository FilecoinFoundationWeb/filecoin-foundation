...
该成果要归功于[FIL+](https://filplus.d.interplanetary.one/about)和[ESPA Bootcamps](https://www.web3espa.io/)等项目以及[硬件提供者](/blog/espa-bootcamp-amd-s-view-on-filecoin-and-web3/)的帮助，这些项目致力于让存储提供者（简称“SP”）的操作更容易、更有效。其他诸如[Filecoin Green](/blog/filecoin-green/)等项目，也在确保该增长与可持续发展目标携手并进，如成为碳中和、甚至是负碳的网络。
...
这些功能还需连接至其他网络，如此Filecoin便可以计算来自其他链的数据。阅读更多关于[FVM解锁的内容](/blog/what-the-fvm-unlocks/)的信息，查看项目[路线图](https://fvm.filecoin.io/#roadmap-4)。

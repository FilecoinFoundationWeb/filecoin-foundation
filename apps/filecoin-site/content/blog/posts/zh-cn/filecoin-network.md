...
为此，Filecoin Network需要调和各类独立的网络参与者。用户、开发者、token持有者、生态伙伴与存储提供者共同组成了Filecoin [海岛经济](/blog/filecoin-s-island-economy/)。
...
- [Filecoin Storage ProviderX奖学金计划](/blog/filecoin-minerx-fellowship-program/)也是针对全球小型SP推出的支持项目。
...
随着[Project Gravity](/blog/filecoin-project-gravity-a-sales-referral-program/)的出现，能处理海量数据集的存储力会面临需求增长。Project Gravity是一个裂变项目，为Filecoin Network吸收此类新用户的社区成员将获得奖励。
...
- 指南：
  - [Filecoin存储提供者指南](/blog/a-guide-to-filecoin-storage-mining/)
  - [Filecoin的海岛经济](/blog/filecoin-s-island-economy/)
  - [Filecoin的加密经济建设](/blog/filecoin-s-cryptoeconomic-constructions/)

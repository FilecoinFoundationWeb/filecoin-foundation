...
FIP0036通过改变对网络流通供应量有重要影响的参数，专门寻求经济因素的激励相容。[流通供应量](/blog/understanding-filecoin-circulating-supply/)是衡量Filecoin网络健康度和表现的重要指标。因为存储提供者需要就其投入的存储资源提供相应的抵押品，那么促使（并鼓励）长期的存储投入意味着更多的token会被锁定在网络中。

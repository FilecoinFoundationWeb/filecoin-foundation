...
**Network**. If using distributed Lotus seal workers (see [Advanced mining considerations](/blog/filecoin-guide-to-storage-mining/#advanced-mining-considerations), below) high-performance networking is suggested (10GbE+ network cards and switches are recommended). High-performance networking is also suggested when using network-attached storage.

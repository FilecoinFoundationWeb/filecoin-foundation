...
The Dawn of an Era: At precisely 3:14 PM UTC on March 14, 2023 (epoch 2,683,348), the [launch](/blog/fvm-is-live-on-mainnet/) of the [Filecoin Virtual Machine](https://fvm.filecoin.io/) (FVM) on Filecoin mainnet brought on-chain programmability and smart contracts live on Filecoin for the first time. This transformational milestone unlocked the promise of an open data economy. For the first time, decentralized applications (dApps) could tap into storage primitives in Filecoin unlocking valuable workflows including perpetual storage, data access control, compute over data and more! 
...
- Important tooling was added with 6 FVM block explorers and wrapped tokens ([wFIL](https://github.com/glifio/wfil?tab=readme-ov-file), [celerFIL](https://cbridge.celer.network/314/1/WFIL), axlFIL).
...
- The journey began with an early builder cohort of 60+ teams who were invited to test and iterate with the FVM core dev team pre-launch. 
...
- FVM marked the Filecoin’s largest hackathon to date (check out the fun [@fvmdev](https://twitter.com/fvmdev)) and hosted full tracks at Fil Dev Summit Singapore and Iceland to gather dev feedback, identify issues and hack together (see ongoing discussions on [dApp development](https://github.com/filecoin-project/community/discussions/677) and [programmatic storage](https://github.com/filecoin-project/community/discussions/676)).

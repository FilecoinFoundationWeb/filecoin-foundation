...
If you would like to stay up to date on what the Filecoin Plus governance team is focusing on, please visit the [Medium](https://medium.com/filecoin-plus) page. Additionally, community members are constantly proposing and discussing ideas to make compliance tracking more open and objective, and this feedback is extremely welcomed. For examples, read more [on GitHub](https://github.com/filecoin-project/notary-governance/discussions).

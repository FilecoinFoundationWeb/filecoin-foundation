...
_Regarding VDFs, we are part of the VDF Alliance alongside the Ethereum Foundation and other organizations. We are funding and supporting research for VDFs; you can read more about our collaboration_ [_in our blog post_](/blog/collaboration-with-the-ethereum-foundation-on-vdfs/)_. Our constructions currently do not use VDFs, but may do so in the future._

...
Now that the Spark University Hackathon has reached a conclusion, we’re shining a spotlight on the winners of the two challenges that Filecoin [sponsored for the event](/blog/spark-university-hackathon)! Last week, we highlighted our [first set of winners](/blog/spark-challenge-one), whose work focused on applications of Filecoin in storing research and scientific data. In this post, we showcase the work of our second set of winners, whose projects addressed the following prompt:

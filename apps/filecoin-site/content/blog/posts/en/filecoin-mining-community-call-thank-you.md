...
Watch the video from the session [on YouTube](https://youtu.be/q5Vwr0cwQuY). We look forward to hosting more Mining Community Calls as we gear up for Mainnet launch! In the meantime, stay tuned for updates on the Filecoin blog. You can also find us on [Wechat](https://www.wechat.com/en/) (ID: Filecoin-Official), the [Filecoin Slack](https://join.slack.com/t/filecoinproject/shared_invite/zt-dj58b7fq-weyaTEvjHoYF_ENkQHR6Ig), and by following us on [Twitter](https://twitter.com/Filecoin). We truly appreciate your participation and your continued support of the Filecoin project!

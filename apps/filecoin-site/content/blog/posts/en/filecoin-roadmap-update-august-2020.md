...
- **HackFS**: HackFS, a 30-day virtual hackathon in collaboration with the ETHGlobal team, helped onboard over 130 projects onto the decentralized web. In total, more than 470 hackers from 50 countries across 19 time zones participated in the event. Dive deeper into the story [behind](/blog/hackfs-teams-vol-1/) [10](/blog/hackfs-teams-vol-2/) [teams](/blog/hackfs-teams-vol-3/) that participated in the hackathon, relive the [HackFS Finale](/blog/30-days-130-projects-recognizing-new-ideas-to-power-web3/) and find out which teams took home prizes, or learn more about all 134 final projects in the HackFS Showcase.

...
export function CarouselButton({
  ...
  return (
    <Button
      ...
      disabled={!canScroll}
      className={clsx(
        'focus:brand-outline grid size-12 cursor-pointer place-items-center rounded-full bg-zinc-800 hover:bg-zinc-700 focus:bg-zinc-700 disabled:cursor-not-allowed disabled:opacity-60 disabled:hover:bg-zinc-800 lg:size-11',
        className,
      )}
      onClick={onClick}
      {...props}

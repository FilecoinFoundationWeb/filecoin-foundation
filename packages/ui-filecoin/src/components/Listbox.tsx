...
export function Listbox<T extends Option>({
  ...
  return (
    <HeadlessListbox value={selected} onChange={setSelected}>
      <ListboxButton className="data-focus:brand-outline focus:brand-outline focus-visible:brand-outline relative block min-w-56 rounded-lg border border-(--color-listbox-border) bg-transparent p-3 text-left font-semibold text-(--color-lisbox-button-text) data-focus:bg-(--color-listbox-button-background)">
